...
%if %{with license_agreement}
Source0:	http://download.macromedia.com/pub/labs/flashplayer9_update/flashplayer9_install_linux_100107.tar.gz
# NoSource0-md5:	15bf5fc8b8465dea5b2233f96224bea0
%else
